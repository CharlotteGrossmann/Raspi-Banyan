...
BANYAN_IP="192.168.2.103" #change this to your backplane IP or type " -b >>your backplane IP<<" when you start the script
...
class test(BanyanBase):
    ...
    def __init__(self, back_plane_ip_address=BANYAN_IP,
        ...
        while True:
            ...
            #define which buttons belongs to which pin
            C1 = 12
            B = 16
            A = 18
            G = 22
            ...
            #set up raspberry to handle the butons
